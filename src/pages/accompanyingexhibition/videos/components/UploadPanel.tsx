...
import { getDays, postAccompanyingExhibitionVideo, type Day } from '../../../../services/accompanyingExhibitionVideosApi';
    ...
    async (videoId: number, itemId: string) => {
      ...
      const poll = async (): Promise<void> => {
        try {
          ...
          const url = `${API_BASE_URL}/api/accompanyingexhibition/videos/${videoId}/`;
    ...
    async (files: File[]) => {
      ...
      for (let i = 0; i < newItems.length; i++) {
        ...
        try {
          ...
          const result = await postAccompanyingExhibitionVideo(formData, (p) => {
            updateQueue((prev) =>
