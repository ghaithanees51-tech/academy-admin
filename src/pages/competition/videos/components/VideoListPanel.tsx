...
import type { CompetitionVideo } from '../../../../services/competitionVideosApi';
    ...
    return (
      <div className={className}>
        <div className="flex flex-col items-center justify-center py-16 px-4 rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50">
          ...
          <p className="text-lg font-medium text-gray-600">{t('competitionVideos.noVideosYet') || 'No videos yet'}</p>
          <p className="text-sm text-gray-500 mt-1">{t('competitionVideos.addUsingPanel') || 'Add videos using the panel on the right'}</p>
        </div>
      </div>
    );
  }
